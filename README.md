![docker image](https://github.com/Guillaume-Gaisne/AMP_internal_Oasis_image/actions/workflows/docker-publish.yml/badge.svg)
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/Guillaume-Gaisne/AMP_internal_Oasis_image/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/Guillaume-Gaisne/AMP_internal_Oasis_image:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/Guillaume-Gaisne/AMP_internal_Oasis_image/manifests/main": unauthorized`
